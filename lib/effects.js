...
module.exports = function(opts) {
	...
	animate((function() {
		...
		var tween = tweener(function(k, lastK) {
			...
			var headerR = k * 80,
				projectsR = ik * -70;
			prefixed(headerContainer.style, "transform", "perspective(800px) rotateX(" + headerR + "deg)");
			prefixed(projects.style, "transform", "perspective(800px) rotateX(" + projectsR + "deg)");
		});
