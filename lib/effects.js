...
module.exports = function(opts) {
	...
	animate((function() {
		...
		var tween = tweener(function(k, lastK) {
			...
			// Delay starting the #projects opacity change so we don't do too
			// many high-cost changes at once. This opacity change seems to
			// cause an initial repaint when becoming non-1 even though the
			// layer should be accelerated
			var k2 = Math.min(1, k / 0.9);
		...
		function setStyles() {
			...
			prefixed(headerContainer.style, "transform", arguments[0]);
